...
class Token_results:
    ...
    def birthday_check(chk):
        if chk ==False:
            print(f"The password FAILED the birthday check. Please do not include your birthday")
        else:
            print("Your password has PASSED the birthday check")

    def number_check(chk):
        if chk ==False:
            print(f"The password FAILED the number check. Please include at least one number")
        else:
